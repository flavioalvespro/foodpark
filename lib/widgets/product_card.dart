  ...
  Widget _buildInfoProduct() 
  {
    return Expanded(
      child: Column (
        ...
        children: <Widget> [
          Text(title, style: TextStyle(color: Colors.black54, fontSize: 16, fontWeight: FontWeight.bold),),
          Container(height: 5),
          Text(description, style: TextStyle(color: Colors.black38, fontSize: 12, fontWeight: FontWeight.normal),),
          Container(height: 7),
          Text("R\$ $price", style: TextStyle(color: Colors.black38, fontSize: 12, fontWeight: FontWeight.w500),)
        ]
      )
    );
  }
